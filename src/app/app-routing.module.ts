...
import { ProbaGuard } from './proba.guard';

const routes: Routes = [
  { path: 'login', component: LoginComponent },
  { path: 'elso', component: ElsoOraComponent, canActivate: [ProbaGuard] }, // a canActivate-tel helyezünk AuthGuardokat a route-okra
  ...
  {
    path: 'parameter/:id',
    component: ParameterProbaComponent,
    canActivate: [ProbaGuard],
  },
